...
(10, 'これならわかるSQL 入門の入門', 'http://www.shoeisha.co.jp/book/detail/9784798114774', 'SQLには、パズルを解く楽しさに通じるものがあります。\r\nSQLの言語仕様は単純明快です。データ操作に限っていえば、基本的な命令は4つしかありません。これらをどのように使用して、いかに目的のデータ操作を達成するかが、SQLの持つ最大の魅力であり、パズルを解く楽しさに似ているところです。', '2017-09-29 01:21:59'),
(11, 'aaaaaaa', 'http://aaaaaaaaa', 'あああああああああああああああああ', '2017-09-30 14:18:29');
